...
// A small, curated word list for the three-word address generation.
// A real application would use a much larger list (e.g., 40,000 words).
export const WORD_LIST: string[] = [
  'able', 'acid', 'aged', 'also', 'area', 'army', 'away', 'baby', 'back', 'ball',
  'band', 'bank', 'base', 'bath', 'bear', 'beat', 'been', 'bell', 'belt', 'best',
  'bill', 'bird', 'blow', 'blue', 'boat', 'body', 'bomb', 'bond', 'bone', 'book',
  'boom', 'born', 'boss', 'both', 'bowl', 'box', 'boy', 'bulk', 'burn', 'bush',
  ...
  'just', 'keen', 'keep', 'kent', 'kept', 'kerb', 'key', 'kick', 'kill', 'kind',
  ...
  'plan', 'play', 'plot', 'plug', 'plus', 'poll', 'pool', 'poor', 'port', 'post',
  ...
  'sure', 'take', 'tale', 'talk', 'tall', 'tank', 'tape', 'task', 'team', 'tech',
  'tell', 'tend', 'term', 'test', 'text', 'than', 'that', 'them', 'then', 'they',
  'thin', 'this', 'thus', 'time', 'tiny', 'told', 'toll', 'tone', 'tony', 'took',
  'tool', 'top', 'torn', 'tour', 'town', 'track', 'tree', 'trip', 'true', 'tune',
  'turn', 'twin', 'type', 'unit', 'upon', 'used', 'user', 'vary', 'vast', 'very',
  'view', 'vote', 'wage', 'wait', 'wake', 'walk', 'wall', 'want', 'ward', 'warm',
  'warn', 'was', 'wash', 'wave', 'ways', 'weak', 'wear', 'week', 'well', 'went',
  'were', 'west', 'what', 'when', 'who', 'whole', 'why', 'wide', 'wife', 'wild',
  'will', 'wind', 'wine', 'wing', 'wire', 'wise', 'wish', 'with', 'wood', 'word',
  'wore', 'work', 'yard', 'yeah', 'year', 'your', 'zone',
];
